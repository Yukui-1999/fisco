...
contract ZS01 {
    // event
    event RegisterdataEvent(int256 ret, string indexed id_time,string indexed total_hash,string indexed part_hash,int256 result);
    ...
    */
    ...
    返回值：
            ...
            -2 其他错误
    */
    function register(string memory id_time, string memory total_hash,string memory part_hash,int256 result) public returns(int256){
        int256 ret_code = 0;
        int256 ret= 0;
        ...
        emit RegisterdataEvent(ret_code, id_time, total_hash,part_hash,result);
